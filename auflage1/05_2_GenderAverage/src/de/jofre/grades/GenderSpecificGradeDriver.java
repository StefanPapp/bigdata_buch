...
public class GenderSpecificGradeDriver extends Configured implements Tool {
	
	private final static Logger log = Logger.getLogger(GenderSpecificGradeDriver.class.getName());

	public static void main(String[] args) {
        int res = 1; // Wenn 1 nicht verändert wird, endet der Job nicht korrekt
		try {
			res = ToolRunner.run(new Configuration(), new GenderSpecificGradeDriver(), args);
		} catch (Exception e) {
