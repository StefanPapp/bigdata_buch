	...
	<div id="container">
		...
		<%
			...
			if (inputText != null) {
				...
				// Klassifiziere Tabellendaten
				String category = Classifier.classify(table.toCSV(headersIncluded));
				out.println("Die ermittelte Kategorie ist: <h2>" + category + "</h2>");
				
				out.println(table.toHTMLTable());
			} else {
				out.println("Wählen Sie vor der Klassifizierung Quelldaten aus HDFS, Hive oder HBase.");
			}
		 %>			
		</div>
		<div id="footer">
