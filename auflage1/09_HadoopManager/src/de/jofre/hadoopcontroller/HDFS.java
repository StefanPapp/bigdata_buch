...
public class HDFS {
	 ...
	 * 
	 * @param url: z.B. hdfs://master:9000
	 * @param username: Benutzername der für die Eigenschaft HADOOP_USER_NAME gesetzt wird
	 */
	 ...
	 * 
	 * @param fullQualifiedName: Absoluter Pfad des neuen Ordners
		...
		if (fs != null) {
			try {
				...
				if (!fs.exists(newFolderPath)) {
					...
					// Und setzen den Besitzer der Datei auf den hduser und dessen
					// Gruppe auf supergroup. Achtung, ist der Benutzername beim Initialisieren
					// des HDFS-Objekts nicht richtig gesetzt, dann schlägt diese Aktion fehl.
	 ...
	 * 
	 * @param dir: Auszulesendes Verzeichnis
	 ...
	 * 
	 * @param file: Absoluter Pfad der herunterzuladenden Datei
	 ...
	 * 
	 * @param entity: Absoluter Pfad zum zu löschenden Objekt.
	 ...
	 * 
	 * @param source: Hochzuladene Datei
	 * @param target: Zielpfad auf dem Server
	 * @return War das Hochladen erfolgreich?
	 */
	public boolean uploadFile(String source, String target) {
		
		log.log(Level.INFO, "Lade Datei hoch von '"+ source +"' nach '"+target+"'...");
