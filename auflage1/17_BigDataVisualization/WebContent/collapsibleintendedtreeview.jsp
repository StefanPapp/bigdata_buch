...
<%
	CollapsibleIntendedTreeview cit = new CollapsibleIntendedTreeview();
...
<body>
	...
	<div id="container">
		...
		<div id="content">
			<%
			cit.setInput(DiagramDummyData.COLLAPSIBLE_INTENDED_TREEVIEW());
			out.println(cit.getJavaScript());
			%>
		</div>
		<div id="footer">
